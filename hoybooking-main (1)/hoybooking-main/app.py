...
def create_app() -> Flask:
    ...
    with app.app_context():
        ...
        # MySQL-specific compatibility patching for older schemas.
        ...
        # Optional bootstrap for deployment: auto-create admin from env vars.
        try:
            from models.user import User

            admin_email = (os.environ.get("HOYBOOKING_ADMIN_EMAIL") or "").strip().lower()
            admin_password = os.environ.get("HOYBOOKING_ADMIN_PASSWORD") or ""
            admin_name = (os.environ.get("HOYBOOKING_ADMIN_NAME") or "Admin").strip()
            reset_on_start = _is_truthy(os.environ.get("HOYBOOKING_ADMIN_RESET_ON_START", ""))
            ...
            print(f"[HOYBOOKING] Warning: failed to bootstrap admin user: {exc}")
